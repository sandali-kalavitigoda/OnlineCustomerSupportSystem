...
<?php 
	...
	$query = "SELECT id,Devices,Description,Drivers FROM drivers";
	...
	if ($result_set) {
		...
		$table = '<table>';
		$table .= '<tr><th>ID</th><th>Devices</th><th>Description</th><th>Link to Download the Driver</th></tr>';

		while ($record = mysqli_fetch_assoc($result_set)) {
			$table .= '<tr>';
			$table .= '<td>' . $record['id'] . '</td>';
			$table .= '<td>' . $record['Devices'] . '</td>';
			$table .= '<td>' . $record['Description'] . '</td>';
			$table .= '<td>' . $record['Drivers'] . '</td>';
...
<link rel="stylesheet" type="text/css" href="styles/stylesSD.css">
<style>
body { margin: 0;}
<center>
...
<script>
alert("Software and Drivers page is loaded");
</script>
</head>
<body>
...
<tr>
<a href="home.html"><img src="images/logo3.jpg" align="140" width="150" height="50"></a>
<a href="home.html"><img src="images/home.png" align="right" width="25" height="25"></a>
<div class="help">
<a href="home.html"><img src="images/help.png" align="right" width="25" height="25"></a>
</div>
</tr>
...
<div class="nav">
  ...
  <a class="active" href="#">Software and Drivers</a>
